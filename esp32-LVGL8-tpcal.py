...
from ili9XXX import ili9488,COLOR_MODE_BGR,LANDSCAPE,PORTRAIT
    
disp = ili9488(miso=19, mosi=23, clk=18, cs=5, dc=26, rst=27, power=-1, backlight=-1, spihost=esp.VSPI_HOST, mhz=40, factor=16, hybrid=True, width=320, height=480, rot=PORTRAIT) 
...
# In order to calibrate in landscape mode please use:
touch = xpt2046(cs=25, spihost=esp.VSPI_HOST, mosi=-1, miso=-1, clk=-1, cal_x0=423, cal_x1 = HRES, cal_y0=3948, cal_y1 = VRES, transpose=True)
